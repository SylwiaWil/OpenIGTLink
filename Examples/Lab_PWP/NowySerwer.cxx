...
void SendChangePoint(igtl::Socket * socket, igtl::PointElement::Pointer pointElement);
...
int main(int argc, char* argv[])
{
	...
	void SendChangeSocet(igtl::Socket * socket)
	{
	}
	...
	int ReceivePoint(igtl::Socket * socket, igtl::MessageHeader * header)
	{
		...
		if (c & igtl::MessageHeader::UNPACK_BODY) // if CRC check is OK
		{
			...
			for (int i = 0; i < nElements; i++)
			{
				...
				SendChangePoint(socket, pointElement);
			}
	...
	void SendChangePoint(igtl::Socket * socket, igtl::PointElement::Pointer pointElement) {
		...
		pointMsg0->AddPointElement(pointElement);
